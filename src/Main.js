				...
				<div className="content">
					<div className="slideshow">
						<div className="slide slide--current">
							<div className="slide__bg slide__bg--1"></div>
							<h2 className="word word--1">Eurhythmic</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--2"></div>
							<h2 className="word word--2">Aquarius</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--3"></div>
							<h2 className="word word--3">Lycanthropy</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--4"></div>
							<h2 className="word word--4">Wonderland</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--5"></div>
							<h2 className="word word--5">Screenager</h2>
						</div>
						<div className="slide">
						...
						<div className="slide">
							<div className="slide__bg slide__bg--7"></div>
							<h2 className="word word--7">Eviternity</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--8"></div>
							<h2 className="word word--8">Jumbuck</h2>
						</div>
						<div className="slide">
							<div className="slide__bg slide__bg--9"></div>
